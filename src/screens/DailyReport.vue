        ...
        <v-container fluid fill-height grid-list-md style="padding:5px;width:80%;">
            <v-layout fill-height column>
                <v-flex style="height:50px;">
                    ...
                    <v-btn flat style="color:white; background-color: rgb(51,82,128);height:30px;" @click="testPDF()">
                ...
                <v-flex style="min-height:1000px;">
                    <v-card flat style="height:100%;">
                        <v-card-title style="height:5%;width:100%;padding-top:5px;padding-bottom:5px; font-size: 24px !important;
                                                        font-weight: 500; line-height: 1 !important;letter-spacing: 0.02em !important; color:rgb(51,82,128);">Engine
                        </v-card-title>
                                ...
                                <v-flex>
                                    <v-layout row style="height: 200px">
                                        <v-flex style="height: 200px">
                                            <TimelineChart class="report-chart"
                                                           v-bind:repClass="'report'"
                                                           v-bind:active="active"
                ...
                <v-flex v-for="n in cylCount" :key="n">
                    <v-card flat style="height:100%;">
                        <v-card-title style="height: 10%;width:100%;padding-top:5px;padding-bottom:5px; font-size: 24px !important; font-weight: 500; line-height: 1 !important;letter-spacing: 0.02em !important; color:rgb(51,82,128);">Cylinder {{n}}
                        </v-card-title>
                        <v-card-actions fill-height style="height:90%;width:100%;padding-top:0px;">
                            <v-layout column>
                                <v-flex>
                                    <v-layout row style="height: 200px">
                                        <v-flex style="height: 200px">
                ...
                <v-flex v-for="n in tcCount" :key="n">
                    <v-card flat style="height:100%;">
                        <v-card-title style="height:10%;width:100%;padding-top:5px;padding-bottom:5px; font-size: 24px !important;
                                                        font-weight: 500; line-height: 1 !important;letter-spacing: 0.02em !important; color:rgb(51,82,128);">T/C {{n}}
                        </v-card-title>
                ...
                <v-flex v-if="showAdditional">
                    <v-card style="height:100%;">
                        <v-card-title style="height:3%;width:100%;padding-top:5px;padding-bottom:5px; font-size: 24px !important; font-weight: 500; line-height: 1 !important;letter-spacing: 0.02em !important; color:rgb(51,82,128);">Data Curves ISO
                        </v-card-title>
                        <v-card-actions style="height:97%;width:100%;padding-top:0px;padding-bottom:0px;">
                            <v-layout>
                                <v-flex>
                                    <v-card style="height:100%;width:100%;">
                                        <v-card-title primary class="title" style="height:initial;width:100%;padding-top:5px;padding-bottom:5px;">ISO - corrected curves vs. engine speed</v-card-title>
                                        <v-card-actions fill-height style="height:98%;width:100%;padding-top:0px;padding-bottom:0px;">
                                            <v-layout column style="height:100%;width:100%;">
                                                <v-flex v-for="isoParam in isoParams['ensp']" :key="isoParam" style="height:250px;">
                                                    <BarChart class="report-chart"
                ...
                <v-flex v-if="showAdditional" style="min-height:1000px;">
                    <v-card flat style="height:100%;">
                        <v-card-title style="height:5%;width:100%;padding-top:5px;padding-bottom:5px; font-size: 24px !important;
                                                        font-weight: 500; line-height: 1 !important;letter-spacing: 0.02em !important; color:rgb(51,82,128);">Tunings
                        </v-card-title>
                        <v-card-actions fill-height style="height:95%;width:100%;padding-top:0px;padding-bottom:0px;">
                            <v-layout column style="height:100%;width:100%;">
                                <v-flex column>
                                    <v-card style="height:100%;width:100%;">
                                        ...
                                        <v-card-actions style="height:95%;width:100%;padding-top:0px;padding-bottom:0px;">
                                ...
                                <v-flex>
                                    <v-card style="height:100%;width:100%;">
                                        <v-card-title primary class="title" style="height:initial;width:100%;padding-top:5px;padding-bottom:5px;">Electronic VEC / VEO</v-card-title>
                                        <v-card-actions fill-height style="height:95%;width:100%;padding-top:0px;padding-bottom:0px;">
                                            <v-layout column style="height:600px">
                                                <v-flex style="height:200px;">
                                                    <BarChart class="report-chart"
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            cylCount: function () {
                return globalStore.cylCount;
            },
            tcCount: function () {
                return globalStore.tcCount;
            },
        },
        mounted() {
        ...
        methods: {
            setData() {
                ...
                if (kpi.toFixed(1) != '100.0')
                    this.$set(this.engineData, 'engineKPI', kpi.toFixed(1));
                else
                    this.$set(this.engineData, 'engineKPI', kpi.toFixed(0));
                ...
                for (let p = 0; p < params.length; p++) {
                    ...
                    for (let i = 0; i < timeStamps.length; i += 3) {
                        ...
                        if ((val == -1000) && (params[p] == 'shaftP')) {
                            ...
                            if (globalStore.signals[timeStamps[i]]['ME_Power_kW'] != -1000)
                                val = globalStore.signals[timeStamps[i]]['ME_Power_kW'];
                            else if (globalStore.signals[timeStamps[i]]['load'] != -1000)
                                val = globalStore.signals[timeStamps[i]]['load'] * mcr;
                        }

                        if (params[p] == 'fRailPres')
                            rfr = globalStore.signals[timeStamps[i]][refs[p]];
                        ...
                        if ((val != -1000) && (rfr != -1000) && (Object.keys(globalStore.limits).includes(params[p]))) {
                            let minLimit = globalStore.limits[params[p]][0],
                                maxLimit = globalStore.limits[params[p]][1];
                ...
                let rpmMcr = Math.round(globalStore.loadDiagram['otVal2']);
                let intNum = 10;
                let lowSpeed = rpmMcr / 2;
                let step = Math.ceil(lowSpeed / (intNum - 2));
                let tick = rpmMcr - (intNum - 1) * step;
                ...
                this.$set(this.gaugeData, 'ensp', {
                    ...
                    rangeLimit: rpmMcr,
                    startValue: customTicks[0],
                    endValue: customTicks[intNum],
                    tickInterval: step,
                    customTicks: customTicks,
                    format: 1,
                    unit: '[rpm]',
                ...
                for (let x = 0; x < xAxis.length; x++) {
                    ...
                    for (let i = 0; i < this.isoParams[xAxis[x]].length; i++) {
                        ...
                        if (i == this.isoParams[xAxis[x]].length - 1)
                            show = true;
                    ...
                    for (let lp = 0; lp < this.isoParams[xAxis[x]].length; lp++) {
                        ...
                        if ((xLast == -1000) && (xAxis[x] == 'shaftP')) {
                            ...
                            if (globalStore.signals[last]['ME_Power_kW'] != -1000)
                                xLast = globalStore.signals[last]['ME_Power_kW'];
                            else if (globalStore.signals[last]['load'] != -1000)
                                xLast = globalStore.signals[last]['load'] * mcr;
                        }
                        ...
                        if ((xLast != -1000) && (globalStore.signals[last][this.isoParams[xAxis[x]][lp][0].replace('_ISO', '')] != -1000))
                            ...
                            if (globalStore.signals[last]['ME_Power_kW'] != -1000)
                                yVal = globalStore.signals[last]['ME_Power_kW'];
                            else if (globalStore.signals[last]['load'] != -1000)
                                yVal = globalStore.signals[last]['load'] * mcr;
                ...
                for (let i = 0; i < this.fields.length; i++) {
                    if (available.includes(this.fields[i])) {
                        ...
                        if (globalStore.signals[last][this.fields[i]] != -1000)
                            ...
                            if (globalStore.signals[last]['ME_Power_kW'] != -1000)
                                val = globalStore.signals[last]['ME_Power_kW'].toFixed(2);
                            else if (globalStore.signals[last]['load'] != -1000)
                                val = (globalStore.signals[last]['load'] * mcr).toFixed(2);
                            else
                                val = 'N/A';
                        } else
                            val = 'N/A';
            ...
            setLoadDiagram() {
                ...
                if (refLength > sigLength)
                    temp = Object.keys(globalStore.signals);
                else
                    temp = Object.keys(globalStore.reference);
            ...
            testPDF() {
                let forPDF = {
                    vessel: globalStore.selectedVessel,
                    imo: globalStore.selectedIMO,
                    type: globalStore.type,
                    cylCount: globalStore.cylCount,
                    tcCount: globalStore.tcCount,
                    mapping: globalStore.mapping,
                    units: globalStore.units,
                    limits: globalStore.limits,
                    showAdditional: this.showAdditional,
                    gaugeData: this.gaugeData,

                    date: Object.keys(globalStore.signals)[0],
                    engineData: this.engineData,
                    subSystemData: this.subSystemData,
                ...
                let date = Object.keys(globalStore.signals)[0].substring(0, 10);
                let reportName = 'edsReport_' + globalStore.selectedVessel + '_' + date + '_' + '.pdf';

                axios.post('http://eds2.propulsionanalytics.com:8081/api/reportinitiate/', forPDF, {responseType: 'blob'}).then(response => {
