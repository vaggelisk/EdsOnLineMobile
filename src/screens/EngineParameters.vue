<template>
    <div v-if="typeof chartData != 'undefined'">
        <v-container fluid style="padding:0px 10px 5px 10px;width:100%;background-color:white;">
            <v-layout>
                <v-flex>
                    <v-layout column>
                        <v-flex style="height:200px;">
                            <BarChart v-if="chartData['pcomp']" v-bind:active="active" v-bind:chartOptions="chartData['pcomp']" v-bind:title="titles['pcomp']"/>
                        </v-flex>
                        <v-flex style="height:200px;">
                            <BarChart v-if="chartData['pmax']" v-bind:active="active" v-bind:chartOptions="chartData['pmax']" v-bind:title="titles['pmax']"/>
                        </v-flex>
                        <v-flex style="height:200px;">
                            <BarChart v-if="chartData['tExhC']" v-bind:active="active" v-bind:chartOptions="chartData['tExhC']" v-bind:title="titles['tExhC']"/>
                        </v-flex>
                    </v-layout>
                </v-flex>
            </v-layout>
    ...
    export default {
        ...
        methods: {
            ...
            setData() {
                ...
                let elCount = [this.cylCount, this.cylCount, this.cylCount, this.tcCount, 0, this.tcCount, this.tcCount, 0, 0, 0];
